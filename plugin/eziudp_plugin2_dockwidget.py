...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'eziudp_plugin2_dockwidget_base.ui'))


class EziudpPlugin2Dockwidget(QtWidgets.QDockWidget, FORM_CLASS):

    closingPlugin = pyqtSignal()

    def __init__(self, parent=None):
        """Constructor."""
        super(EziudpPlugin2Dockwidget, self).__init__(parent)
